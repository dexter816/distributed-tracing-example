...
set_target_properties(jaegertracing::jaegertracing PROPERTIES
  IMPORTED_LOCATION_NOCONFIG "${_IMPORT_PREFIX}/lib/libjaegertracing.so.0.3.0"
  IMPORTED_SONAME_NOCONFIG "libjaegertracing.so.0"
  )

list(APPEND _IMPORT_CHECK_TARGETS jaegertracing::jaegertracing )
list(APPEND _IMPORT_CHECK_FILES_FOR_jaegertracing::jaegertracing "${_IMPORT_PREFIX}/lib/libjaegertracing.so.0.3.0" )
